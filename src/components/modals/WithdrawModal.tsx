      ...
      title={
        <>
          <div className="w-full flex flex-col gap-1">
            ...
            <h2 className="text-xl font-bold text-[#1a1a1a]">출금 신청</h2>
            <p className="text-xs text-[#8a7560]">
              보유머니와 출금 계좌를 확인하고 출금을 신청해주세요.
            </p>
          </div>
        </>
      }
    >
      <div className="min-h-0 flex-1 space-y-5 overflow-y-auto p-5 scrollbar">
            ...
            <table className="w-full text-sm">
              <tbody>
                <tr className="border-b border-[#ead9b0]">
                  <td className="w-32.5 bg-[#f8f1df] px-4 py-3 text-[#8a7560]">출금정보</td>
                  <td className="px-4 py-3 text-left text-[#1a1a1a] font-bold">
                ...
                <tr className="border-b border-[#ead9b0]">
                  <td className="w-32.5 bg-[#f8f1df] px-4 py-3 text-[#8a7560]">환전비번</td>
                ...
                <tr className="border-b border-[#ead9b0]">
                  <td className="w-32.5 bg-[#f8f1df] px-4 py-3 text-[#8a7560]">출금금액</td>
                  <td className="px-4 py-3 text-left font-bold">
                    <Input
        ...
        <div className="border border-[#ead9b0] rounded-xl bg-[#fbf7f0] text-sm text-[#8a7560] p-4">
          <h3 className="mb-3 text-lg font-bold text-[#a6853d]">환전시 주의사항</h3>
        ...
        <div className="border border-[#ead9b0] rounded-xl bg-[#fbf7f0] overflow-hidden">
          <div className="border-b border-[#ead9b0] px-4 py-3 text-lg font-bold text-[#a6853d]">출금내역</div>
